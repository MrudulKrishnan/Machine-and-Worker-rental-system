...
public class send_rating_review_user extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Spinner sp1_product;
    ...
    String url, rating_str, review_str ,product_str, product_id_str, title;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_send_rating_review_user);

        sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        sp1_product = findViewById(R.id.SP1_Product);
        ...
        RequestQueue queue = Volley.newRequestQueue(send_rating_review_user.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Log.d("+++++++++++++++++", response);
                try {
                    Toast.makeText(send_rating_review_user.this, "err" + response, Toast.LENGTH_SHORT).show();
                    ...
                    ArrayAdapter<String> ad=new ArrayAdapter<>(send_rating_review_user.this,android.R.layout.simple_list_item_1,product_arr );
                    sp1_product.setAdapter(ad);
                    sp1_product.setOnItemSelectedListener(send_rating_review_user.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(send_rating_review_user.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
