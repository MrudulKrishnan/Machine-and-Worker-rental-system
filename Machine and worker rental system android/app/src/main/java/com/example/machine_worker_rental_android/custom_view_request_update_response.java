...
class custom_view_request_update_response extends BaseAdapter {
    private Context context;
    ArrayList<String> skill_arr, type_arr, date_arr, exp_arr;

    Button send_request;
    SharedPreferences sh;
    public custom_view_request_update_response(Context applicationContext, ArrayList<String> skill_arg,
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_request_update_response,null);
