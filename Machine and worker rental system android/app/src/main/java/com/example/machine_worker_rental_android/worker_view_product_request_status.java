...
public class worker_view_product_request_status extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ListView l1_request;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worker_view_product_request_status);
...
//        });
        ...
        RequestQueue queue = Volley.newRequestQueue(worker_view_product_request_status.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Log.d("+++++++++++++++++", response);
                try {
                    Toast.makeText(worker_view_product_request_status.this, "" + response, Toast.LENGTH_SHORT).show();
                    ...
                    l1_request.setAdapter(new custom_view_product_request_status(worker_view_product_request_status.this,
                            worker_name_arr, worker_phone_arr, date_arr, status_arr, worker_request_id_arr));
                    l1_request.setOnItemClickListener(worker_view_product_request_status.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(worker_view_product_request_status.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(status_arr.get(i).equalsIgnoreCase("pending")) {
            Toast.makeText(worker_view_product_request_status.this, "waiting for shop response", Toast.LENGTH_SHORT).show();
        }
        else {

            Toast.makeText(worker_view_product_request_status.this, " shop response",Toast.LENGTH_SHORT).show();

            AlertDialog.Builder ald = new AlertDialog.Builder(worker_view_product_request_status.this);
            ald.setTitle("title")
