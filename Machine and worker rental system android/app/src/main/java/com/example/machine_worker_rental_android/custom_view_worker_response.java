...
class custom_view_worker_response extends BaseAdapter {
    private Context context;
    ArrayList<String> worker_name_arr, worker_phone_arr, date_arr, status_arr, work_details_arr, worker_request_id_arr;
    Button send_request;
    SharedPreferences sh;
    public custom_view_worker_response(Context applicationContext, ArrayList<String> worker_name_arg,
                                       ArrayList<String> worker_phone_arg, ArrayList<String> date_arg,
                                       ArrayList<String> status_arg, ArrayList<String> work_details_arg,
                                       ArrayList<String> worker_request_id_arg)
    {
        ...
        this.work_details_arr = work_details_arg;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_view_worker_response,null);
        ...
        TextView tv5_work_details = (TextView)gridView.findViewById(R.id.TV5_ViewWorkerResponseDetails);
