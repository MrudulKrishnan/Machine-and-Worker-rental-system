...
class custom_view_product extends BaseAdapter {
    ...
    String url;
    public custom_view_product(Context applicationContext, ArrayList<String> product_name_arg,
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        b1_product_request.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                url = "http://"+sh.getString("ip","")+":5000/product_request_send";
