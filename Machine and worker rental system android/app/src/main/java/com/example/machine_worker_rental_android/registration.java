...
public class registration extends AppCompatActivity {
    ...
    String firstname_str, lastname_str, age_str, gender_str, place_str, post_str, pin_str, phone_str,
            email_str, latitude_str, longitude_str, username_str, password_str, url, title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latitude = findViewById(R.id.e13_Latitude);
        longitude = findViewById(R.id.e14_Longitude);
...
//                proof_str = proof.getText().toString();
                ...
                }else if (latitude_str.equalsIgnoreCase("")) {
                    latitude.setError("Enter Your latitude");
                }else if (longitude_str.equalsIgnoreCase("")) {
...
//                        Toast.makeText(Upload_agreement.this, "Report Sent Successfully", Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("Firstname", firstname_str);
                params.put("Lastname", lastname_str);
