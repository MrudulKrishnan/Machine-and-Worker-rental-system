...
public class send_new_complaint extends AppCompatActivity implements AdapterView.OnItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        RequestQueue queue = Volley.newRequestQueue(send_new_complaint.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Log.d("+++++++++++++++++", response);
                try {
                    Toast.makeText(send_new_complaint.this, "err" + response, Toast.LENGTH_SHORT).show();
                    ...
                    ArrayAdapter<String> ad=new ArrayAdapter<>(send_new_complaint.this,android.R.layout.simple_list_item_1,shop_name_arr );
                    sp1_shop.setAdapter(ad);
                    sp1_shop.setOnItemSelectedListener(send_new_complaint.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(send_new_complaint.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (res.equalsIgnoreCase("success")) {
                                    Toast.makeText(send_new_complaint.this, "Complaint sent successfully ", Toast.LENGTH_SHORT).show();
                                    Intent ik = new Intent(getApplicationContext(), workers_home.class);
                                    startActivity(ik);
                                } else {
                                    Toast.makeText(send_new_complaint.this, "please try again", Toast.LENGTH_SHORT).show();
                                }
