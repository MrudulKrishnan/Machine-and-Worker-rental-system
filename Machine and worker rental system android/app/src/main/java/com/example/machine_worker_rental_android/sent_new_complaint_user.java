...
public class sent_new_complaint_user extends AppCompatActivity implements AdapterView.OnItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_sent_new_complaint_user);
        ...
        RequestQueue queue = Volley.newRequestQueue(sent_new_complaint_user.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Log.d("+++++++++++++++++", response);
                try {
                    Toast.makeText(sent_new_complaint_user.this, "err" + response, Toast.LENGTH_SHORT).show();
                    ...
                    ArrayAdapter<String> ad=new ArrayAdapter<>(sent_new_complaint_user.this,android.R.layout.simple_list_item_1,shop_name_arr );
                    sp1_shop.setAdapter(ad);
                    sp1_shop.setOnItemSelectedListener(sent_new_complaint_user.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(sent_new_complaint_user.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if (res.equalsIgnoreCase("success")) {
                                    Toast.makeText(sent_new_complaint_user.this, "Complaint sent successfully ", Toast.LENGTH_SHORT).show();
                                    Intent ik = new Intent(getApplicationContext(), workers_home.class);
                                    startActivity(ik);
                                } else {
                                    Toast.makeText(sent_new_complaint_user.this, "please try again", Toast.LENGTH_SHORT).show();
                                }
