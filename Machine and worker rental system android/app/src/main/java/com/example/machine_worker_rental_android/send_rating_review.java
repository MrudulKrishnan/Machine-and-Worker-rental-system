...
public class send_rating_review extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Spinner sp1_product;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Log.d("+++++++++++++++++", response);
                try {
                    Toast.makeText(send_rating_review.this, "err" + response, Toast.LENGTH_SHORT).show();
                    ...
                    for (int i=0; i<ar.length(); i++) {
                     ...
                     ArrayAdapter<String> ad=new ArrayAdapter<>(send_rating_review.this,android.R.layout.simple_list_item_1,product_arr );
                    sp1_product.setAdapter(ad);
                    sp1_product.setOnItemSelectedListener(send_rating_review.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(send_rating_review.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                ...
                                if(res.equalsIgnoreCase("success"))
                                {
                                    ...
                                    Intent in=new Intent(getApplicationContext(),workers_home.class)	;
